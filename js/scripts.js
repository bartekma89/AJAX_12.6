    ...
    (function($) {
        ...
        function CountryInfor(obj) {
            ...
            function create() {
                ...
                fillSimpleData(
                    'Language',
                    self.languages[0].name,
                    $languageRow
                );

                fillSimpleData(
                    'Currency',
                    self.currencies[0].name,
                    $currencyRow
                );
                ...
                function fillSimpleData(description, property, $elementRow) {
                    ...
                    $elementColumnDesc.append($elementDescription);
                    $elementColumnName.append($elementName);

                    $elementRow
                        .append($elementColumnDesc)
                ...
                function fillHeaderData(property) {
                    ...
                    var $countryName = $('<h3 class="countryName">').text(
                        property[1]
                    );
                    $nameColumn.append($countryName);
                    $headerRow.append($flagColumn).append($nameColumn);
                }
            }
